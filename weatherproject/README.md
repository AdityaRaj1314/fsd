...
This is a Django project designed for presenting weather information.
...
- **`weatherproject/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`weatherproject/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
