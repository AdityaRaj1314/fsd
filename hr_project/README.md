...
This is a Django project designed to manage employee records and search based on salaries.
...
- **`hr_project/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`hr_project/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
