...
This is a Django project designed to display or manage Biodata.
...
- **`biodata/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`biodata/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
