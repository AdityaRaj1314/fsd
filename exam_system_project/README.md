...
This is a Django project designed for an Exam Management System.
...
- **`exam_system_project/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`exam_system_project/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
