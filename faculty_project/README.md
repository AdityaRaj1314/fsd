...
This is a Django project designed to manage faculty details and filter them by department.
...
- **`faculty_project/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`faculty_project/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
