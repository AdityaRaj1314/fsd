...
This is a Django project designed to store student grades and update a student's grade dynamically based on their name.
...
- **`student_grade_project/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`student_grade_project/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
