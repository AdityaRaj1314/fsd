...
This is a Django project designed to manage basic student information.
...
- **`studentproject/settings.py`**: Add your created apps to `INSTALLED_APPS` here.
- **`studentproject/urls.py`**: The main URL configuration. Route main paths here using `include('app_name.urls')`.
